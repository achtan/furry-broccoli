...
import { Atom as Box } from './Atom'
import { Row as Flex } from './Row'
...
export const Input = forwardRef((props, ref) => (
  <Box
    ...
    __css={{
      ...
      border: 'none',
      color: 'inherit',
      bg: props.disabled ? 'grey2' : 'transparent',
...
export const Radio = forwardRef(({ className, sx, variant = 'radio', ...props }, ref) => (
  <Box>
    <Box
      ref={ref}
      as="input"
...
//   <Box ref={ref} as="input" type="radio" {...props} mr={1} />
// ))
